...
import { columns } from 'src/views/pages/inventory/transactions/purchase/static-data'
...
const pageTitle = 'Purchase Transaction'
                  ...
                  {isAllowed(permissions, 'R') && (
                    <Tooltip title='Detail' placement='top'>
                      <IconButton size='small'>
                        <Link
                          href={setRedirectUrl({
                            url: '/inventory/transactions/purchase/form',
          ...
          <Card>
            ...
            <DataGrid
              ...
              componentsProps={{
                ...
                toolbar: {
                  onClick: () => push('/inventory/transactions/purchase/form'),
