...
export const SupplierForm = ({ control, states, handleDiscard, onSubmit, handleSubmit, errors, pageTitle }) => {
  return (
    <Modal
      onsubmit={onsubmit}
              ...
              <Controller
                ...
                render={({ field: { value } }) => (
                  <TextField
                    ...
                    color='secondary'
                    label='Supplier Code'
                    placeholder='Supplier Code AUTO'
                    size='small'
                  />
                )}
              />
              ...
              <Controller
                ...
                render={({ field: { value, onChange } }) => (
                  <TextField
                    ...
                    helperText={Boolean(errors.suppliername) && 'Required'}
                  />
                )}
              />
            </FormControl>
